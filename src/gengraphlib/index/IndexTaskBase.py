...
from ..common import KeyValTypes, KeyType, KeyIndexType, keyIndexInfo, KeyIndexState, KeyInfo
...
class IndexTaskBase[ T: KeyValTypes ]( TaskBase, IndexTaskInterface ):
    ...
    def __init__(self: Self, key_info: KeyInfo, bootlog_info: BootLogInfo ) -> None:
        ...
        self._keyinfo_id: str = f"{self._bootlog_info.schema_bootid}@{key_info.key}"
