...
from src.gengraphlib import KeyValueSchema, Column, GraphTable


class GraphFileBase( ABC ):

    def __init__( self: Self, _schema: KeyValueSchema, _vector: GraphTable, file_path: str ):
        super().__init__()
        self._schema: KeyValueSchema = _schema
        self._vector: GraphTable    = _vector
...
class GraphFileSource( GraphFileBase ):
    def __init__( self: Self, key_graph: KeyValueSchema, _vector: GraphTable, file_path: str ):
